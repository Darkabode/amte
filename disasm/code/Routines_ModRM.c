void __stdcall MOD_RM(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    GV.DECALAGE_EIP = 0;
    if (!Security(1, pMyDisasm)) return;
    GV.MOD_ = ((*((uint8_t*)(puint_t) (GV.EIP_+1))) >> 6) & 0x3;
    GV.RM_  = (*((uint8_t*)(puint_t) (GV.EIP_+1))) & 0x7;
    if (GV.MOD_ == 0) {
 ...
 *
 * ======================================= */
void __stdcall Reg_Opcode(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    if (!Security(1, pMyDisasm)) return;
 ...
 *          ModRM_0
 * ======================================= */
void __stdcall Addr_EAX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    #ifndef BEA_LIGHT_DISASSEMBLY
	size_t i = 0;
    #endif
 ...
 *
 * ======================================= */
void __stdcall Addr_ECX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    #ifndef BEA_LIGHT_DISASSEMBLY
    size_t i = 0;
	#endif
 ...
 *
 * ======================================= */
void __stdcall Addr_EDX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    #ifndef BEA_LIGHT_DISASSEMBLY
		size_t i = 0;
	#endif
 ...
 *
 * ======================================= */
void __stdcall Addr_EBX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    #ifndef BEA_LIGHT_DISASSEMBLY
	size_t i = 0;
	#endif
 ...
 *
 * ======================================= */
void __stdcall Addr_SIB(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    if (!Security(2, pMyDisasm)) return;
    (*pMyArgument).ArgType = MEMORY_TYPE;
    if (GV.AddressSize >= 32) {
        GV.DECALAGE_EIP++;
        GV.BASE_  = ((uint8_t) *((uint8_t*) (puint_t) (GV.EIP_+2))) & 0x7;
        GV.SCALE_  = (((uint8_t) *((uint8_t*) (puint_t)(GV.EIP_+2))) & 0xc0) >> 6;
        GV.INDEX_  = (((uint8_t) *((uint8_t*) (puint_t)(GV.EIP_+2))) & 0x38) >> 3;
 ...
 *
 * ======================================= */
void __stdcall Addr_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int32_t MyNumber;
    uint64_t MyAddress;
    size_t i = 0;
    ...
    if (GV.AddressSize >= 32) {
        ...
        GV.DECALAGE_EIP+=4;
        MyNumber = *((int32_t*)(puint_t) (GV.EIP_+2));
        ...
        if (GV.Architecture == 64) {
            ...
            #ifndef BEA_LIGHT_DISASSEMBLY
               i+= CopyFormattedNumber(pMyDisasm, (char*) (*pMyArgument).ArgMnemonic+i,"%.16llX", (int64_t)MyAddress);
            #endif
            (*pMyArgument).ArgType |= RELATIVE_;
        }
        else {
            #ifndef BEA_LIGHT_DISASSEMBLY
               i+= CopyFormattedNumber(pMyDisasm, (char*) (*pMyArgument).ArgMnemonic+i,"%.8X", (int64_t)MyNumber);
            #endif
        }
    }
    else {
 ...
 *
 * ======================================= */
void __stdcall Addr_ESI(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    long MyNumber;
    #ifndef BEA_LIGHT_DISASSEMBLY
	size_t i = 0;
    ...
    if (GV.AddressSize == 64) {
        ...
        GV.DECALAGE_EIP+=2;
        MyNumber = *((uint16_t*)(puint_t) (GV.EIP_+2));
        (*pMyArgument).Memory.Displacement = MyNumber;
        if (!Security(2, pMyDisasm)) return;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) CopyFormattedNumber(pMyDisasm, (char*) (*pMyArgument).ArgMnemonic+i,"%.4X", (int64_t)MyNumber);
        #endif
    }
}
 ...
 *
 * ======================================= */
void __stdcall Addr_EDI(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    #ifndef BEA_LIGHT_DISASSEMBLY
	size_t i = 0;
	#endif
 ...
 *          ModRM_1
 * ======================================= */
void __stdcall Addr_EAX_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    MyNumber = *((int8_t*)(puint_t) (GV.EIP_+2));
    (*pMyArgument).Memory.Displacement = MyNumber;
    (*pMyArgument).ArgType = MEMORY_TYPE;
    if (GV.AddressSize == 64) {
        if (GV.REX.B_ == 1) {
    ...
    i = strlen ((char*) &(*pMyArgument).ArgMnemonic);
        ...
        if (MyNumber < 0) {
            ...
            i++;
            #ifndef BEA_LIGHT_DISASSEMBLY
               i+= CopyFormattedNumber(pMyDisasm, (char*) (*pMyArgument).ArgMnemonic+i,"%.2X",(int64_t) ~MyNumber+1);
            #endif
        }
        else {
            #ifndef BEA_LIGHT_DISASSEMBLY
            ...
            i++;
            #ifndef BEA_LIGHT_DISASSEMBLY
               i+= CopyFormattedNumber(pMyDisasm, (char*) (*pMyArgument).ArgMnemonic+i,"%.2X",(int64_t) MyNumber);
            #endif
        }
}
 ...
 *          ModRM_1
 * ======================================= */
void __stdcall Addr_ECX_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    MyNumber = (int8_t) *((uint8_t*) (puint_t)GV.EIP_+2);
    (*pMyArgument).Memory.Displacement = MyNumber;
    (*pMyArgument).ArgType = MEMORY_TYPE;
    if (GV.AddressSize == 64) {
        if (GV.REX.B_ == 1) {
 ...
 *          ModRM_1
 * ======================================= */
void __stdcall Addr_EDX_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    MyNumber = *((int8_t*)(puint_t) (GV.EIP_+2));
 ...
 *          ModRM_1
 * ======================================= */
void __stdcall Addr_EBX_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    MyNumber = *((int8_t*)(puint_t) (GV.EIP_+2));
 ...
 *
 * ======================================= */
void __stdcall Addr_SIB_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0, j;
    long MyNumber;
    if (!Security(2, pMyDisasm)) return;
    if (GV.AddressSize >= 32) {
        MyNumber = *((int8_t*)(puint_t) (GV.EIP_+3));
    }
    else {
        MyNumber = *((int8_t*)(puint_t) (GV.EIP_+2));
    }
    ...
    if (GV.AddressSize >= 32) {
        GV.DECALAGE_EIP++;
        GV.BASE_  = (*((uint8_t*)(puint_t) (GV.EIP_+2))) & 0x7;
        GV.SCALE_  = ((*((uint8_t*)(puint_t) (GV.EIP_+2))) & 0xc0) >> 6;
        GV.INDEX_  = ((*((uint8_t*)(puint_t) (GV.EIP_+2))) & 0x38) >> 3;
        j = i;
 ...
 *          ModRM_1
 * ======================================= */
void __stdcall Addr_EBP_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    MyNumber = *((int8_t*)(puint_t) (GV.EIP_+2));
 ...
 *          ModRM_1
 * ======================================= */
void __stdcall Addr_ESI_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    MyNumber = *((int8_t*)(puint_t) (GV.EIP_+2));
 ...
 *          ModRM_1
 * ======================================= */
void __stdcall Addr_EDI_disp8(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    MyNumber = *((int8_t*)(puint_t) (GV.EIP_+2));
 ...
 *          ModRM_2
 * ======================================= */
void __stdcall Addr_EAX_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    if (GV.AddressSize == 16) {
        MyNumber = *((int16_t*)(puint_t) (GV.EIP_+2));
    }
    else{
        MyNumber = *((int32_t*)(puint_t) (GV.EIP_+2));
    }
    ...
    i = strlen ((char*) &(*pMyArgument).ArgMnemonic);
        ...
        if (MyNumber < 0) {
            ...
            i++;
            #ifndef BEA_LIGHT_DISASSEMBLY
               i+= CopyFormattedNumber(pMyDisasm, (char*) (*pMyArgument).ArgMnemonic+i,"%.8X",(int64_t) ~MyNumber+1);
            #endif
        }
        else {
            #ifndef BEA_LIGHT_DISASSEMBLY
 ...
 *          ModRM_2
 * ======================================= */
void __stdcall Addr_ECX_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    if (GV.AddressSize == 16) {
 ...
 *          ModRM_2
 * ======================================= */
void __stdcall Addr_EDX_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    if (GV.AddressSize == 16) {
 ...
 *          ModRM_2
 * ======================================= */
void __stdcall Addr_EBX_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    if (GV.AddressSize == 16) {
 ...
 *
 * ======================================= */
void __stdcall Addr_SIB_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0, j;
    long MyNumber;
    if (!Security(2, pMyDisasm)) return;
    if (GV.AddressSize >= 32) {
        MyNumber = *((int32_t*)(puint_t) (GV.EIP_+3));
    }
    else {
        MyNumber = *((int16_t*)(puint_t) (GV.EIP_+2));
    }
 ...
 *          ModRM_2
 * ======================================= */
void __stdcall Addr_EBP_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    if (GV.AddressSize == 16) {
 ...
 *          ModRM_2
 * ======================================= */
void __stdcall Addr_ESI_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    if (GV.AddressSize == 16) {
 ...
 *          ModRM_2
 * ======================================= */
void __stdcall Addr_EDI_disp32(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    size_t i = 0;
    long MyNumber;
    if (GV.AddressSize == 16) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rEAX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rECX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rEDX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rEBX(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rESP(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rEBP(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rESI(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *          ModRM_3
 * ======================================= */
void __stdcall _rEDI(ARGTYPE* pMyArgument, PDISASM pMyDisasm)
{
    int i = 0;
    GV.MemDecoration = 0;
    if (GV.MMX_  == 1) {
 ...
 *
 * ======================================= */
size_t __stdcall SIB_0(ARGTYPE* pMyArgument, size_t i, PDISASM pMyDisasm)
{
    ...
    if ((GV.BASE_  == 5) && (GV.MOD_ == 0)) {
        ...
        j = i;
        #ifndef BEA_LIGHT_DISASSEMBLY
           i+= CopyFormattedNumber(pMyDisasm, (char*) (*pMyArgument).ArgMnemonic+j,"%.8X",(int64_t) *((uint32_t*)(puint_t) (GV.EIP_+3)));
        #endif
        (*pMyArgument).Memory.Displacement = *((uint32_t*)(puint_t) (GV.EIP_+3));
 ...
 *
 * ======================================= */
size_t __stdcall SIB_1(ARGTYPE* pMyArgument, size_t i, PDISASM pMyDisasm)
{
    size_t j;
    /* ========================= Interpret Base */
 ...
 *
 * ======================================= */
size_t __stdcall SIB_2(ARGTYPE* pMyArgument, size_t i, PDISASM pMyDisasm)
{
    size_t j;
    /* ========================= Interpret Base */
 ...
 *
 * ======================================= */
size_t __stdcall SIB_3(ARGTYPE* pMyArgument, size_t i, PDISASM pMyDisasm)
{
    size_t j;
    /* ========================= Interpret Base */
