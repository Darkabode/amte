...
void (__stdcall *ModRM_0[])(ARGTYPE*, PDISASM) = {
     Addr_EAX,
     Addr_ECX,
     Addr_EDX,
     Addr_EBX,
 ...
 void (__stdcall *ModRM_1[])(ARGTYPE*, PDISASM) = {
     Addr_EAX_disp8,
     Addr_ECX_disp8,
     Addr_EDX_disp8,
     Addr_EBX_disp8,
 ...
 void (__stdcall *ModRM_2[])(ARGTYPE*, PDISASM) = {
     Addr_EAX_disp32,
     Addr_ECX_disp32,
     Addr_EDX_disp32,
     Addr_EBX_disp32,
 ...
 void (__stdcall *ModRM_3[])(ARGTYPE*, PDISASM) = {
     _rEAX,
     _rECX,
     _rEDX,
     _rEBX,
...
size_t (__stdcall *SIB[])(ARGTYPE*, size_t, PDISASM) = {
     SIB_0,
     SIB_1,
     SIB_2,
     SIB_3,
