...
/* ====================================== Routines_MODRM */
void __stdcall MOD_RM(ARGTYPE*, PDISASM);
void __stdcall Reg_Opcode(ARGTYPE*, PDISASM);

void __stdcall Addr_EAX(ARGTYPE*, PDISASM);
void __stdcall Addr_ECX(ARGTYPE*, PDISASM);
void __stdcall Addr_EDX(ARGTYPE*, PDISASM);
void __stdcall Addr_EBX(ARGTYPE*, PDISASM);
void __stdcall Addr_SIB(ARGTYPE*, PDISASM);
void __stdcall Addr_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_ESI(ARGTYPE*, PDISASM);
void __stdcall Addr_EDI(ARGTYPE*, PDISASM);

void __stdcall Addr_EAX_disp8(ARGTYPE*, PDISASM);
void __stdcall Addr_ECX_disp8(ARGTYPE*, PDISASM);
void __stdcall Addr_EDX_disp8(ARGTYPE*, PDISASM);
void __stdcall Addr_EBX_disp8(ARGTYPE*, PDISASM);
void __stdcall Addr_SIB_disp8(ARGTYPE*, PDISASM);
void __stdcall Addr_EBP_disp8(ARGTYPE*, PDISASM);
void __stdcall Addr_ESI_disp8(ARGTYPE*, PDISASM);
void __stdcall Addr_EDI_disp8(ARGTYPE*, PDISASM);

void __stdcall Addr_EAX_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_ECX_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_EDX_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_EBX_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_SIB_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_EBP_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_ESI_disp32(ARGTYPE*, PDISASM);
void __stdcall Addr_EDI_disp32(ARGTYPE*, PDISASM);

void __stdcall _rEAX(ARGTYPE*, PDISASM);
void __stdcall _rECX(ARGTYPE*, PDISASM);
void __stdcall _rEDX(ARGTYPE*, PDISASM);
void __stdcall _rEBX(ARGTYPE*, PDISASM);
void __stdcall _rESP(ARGTYPE*, PDISASM);
void __stdcall _rEBP(ARGTYPE*, PDISASM);
void __stdcall _rESI(ARGTYPE*, PDISASM);
void __stdcall _rEDI(ARGTYPE*, PDISASM);

size_t __stdcall SIB_0(ARGTYPE*, size_t, PDISASM);
size_t __stdcall SIB_1(ARGTYPE*, size_t, PDISASM);
size_t __stdcall SIB_2(ARGTYPE*, size_t, PDISASM);
size_t __stdcall SIB_3(ARGTYPE*, size_t, PDISASM);

/* ====================================== Routines_Disasm */
void __stdcall CompleteInstructionFields (PDISASM);
...
int __stdcall Security(int, PDISASM);
void __stdcall CalculateRelativeAddress(uint64_t *, int64_t, PDISASM);
size_t __stdcall CopyFormattedNumber(PDISASM, char*, const char*, int64_t);
void __stdcall BuildCompleteInstruction(PDISASM);
void __stdcall BuildCompleteInstructionATSyntax(PDISASM);
int __stdcall InitVariables (PDISASM);
